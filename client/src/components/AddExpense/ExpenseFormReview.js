...
const ExpenseFormReview = ( { onCancel, formValues, submitExpense, userId, history }) => {
    ...
    formValues['expenseMonth'] = month;
    formValues['expenseYear'] = year;
            ...
            <div className="container" style={{marginTop: "40px"}}>
                ...
                <div>
                    <div>
                        ...
                        <div>{formValues.expenseType}</div>
                    </div>
                    <div>
                        <label>Amount*</label>
...
function mapStateToProps(state) {
    ...
    return {
        formValues: state.form.ExpenseForm.values,
